...
lineage_ct %>% ggplot(aes(Lineage)) + geom_bar(aes(y=counts), stat="identity")  +
  ...
  theme(axis.text.x = element_text(size=10, angle = 300, hjust = 0.05), axis.text.y = element_text(size=10), axis.title.x = element_text(size=10), 
        axis.title.y = element_text(size=10), strip.text.x = element_text(size=10))
...
mpxv_biweekly_cts %>% ggplot(aes(x=as.factor(date_index),y=count, fill=Category)) + geom_bar(stat="identity") + 
  ...
  theme(axis.text.x = element_text( size=8, angle=90,vjust=0.6, hjust = 0.9), axis.text.y = element_text( size=8), legend.text = element_text( size=10),
        legend.title = element_blank(), legend.position = c(0.87,0.9), axis.title.x = element_text(size=10), 
        axis.title.y = element_text(size=10), legend.background = element_rect(color="#969696") ) + 
